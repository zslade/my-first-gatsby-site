  ...
  return (
    <Layout pageTitle="About Graph Blog">
      <p>
        ...
        It is also a personal playground where I can get creative with coding and overengineer things for fun!
      </p>
      <h2>The graph</h2>
      <p>
        The graph on the home page acts as the blog's contents page.
        The little circles (a.k.a. nodes) represent blog articles, colour-coded according to subject. Clicking on the article's title will take you to the article itself.
        Articles are linked to one another through common themes. 
        As the number of articles grows, I plan to introduce more interesting ways of linking and filtering articles.
      </p>
      <h3>Why?</h3>
      <p>
        I chose to design my blog this way because it allowed me to visually represent the interconnectedness of things.
      ...
      <p>
        ...
        I used <a href="https://observablehq.com" style={{color: "#626262"}}>Observable notebooks</a> to develop the graph on the Home page before integrating with the Gatsby site.
        All source code for the blog is contained in <a href="" style={{color: "#626262"}}>this GitHub repo</a>.
        Feel free to report any bugs you find or share ideas for improvements via GitHub issues.
      </p>
      <h2>The site</h2>
      <p>
        ...
        <ul>
          <li>A "key" for article subjects</li>
      ...
      <p>
        I post about my latest blog articles on <a href="" style={{color: "#626262"}}>my LinkedIn</a> if you'd like to stay up to date.
      </p>
    </Layout>
  )
}
